...
const Search = () => {
  return (
    <div className=' max-w-[1240px] mx-auto gap-4  grid lg:grid-cols-3 px-4 py-16 '>
    ...
    <p className='py-1'>ALL-INCLUSIVE COMPANY FOR 20 YEARS IN-A-ROW</p>
      ...
      <div>
        <div className='border text-center '>
          ...
          <p className='bg-gray-800 text-gray-300 py-2'>BOOK NOW AND SAFE</p>
        </div>
        <form className='w-full'>
  {/* form here */}
  <div className='flex flex-col my-2'>
    <label>Destination</label>
    <select className='border rounded-sm p-2'>
